...
const sosmedVariants: sosmedVariant[] = [
  {
    icon: BsInstagram,
    link: "https://www.instagram.com/syhrialm_/",
  },
  {
    icon: BsLinkedin,
    link: "https://www.linkedin.com/in/muhammad-syahrial-a97966221/",
  },
  {
    icon: IoMailSharp,
    link: "mailto:syr06rial@gmail.com",
  },
  {
    icon: BsGithub,
    link: "https://github.com/syahrial6/",
  },
];
...
const Footer = () => {
  return (
    <div
      id="footer"
      className="text-white w-[90vw] m-auto p-4 mt-24 text-center font-primary lg:mb-12 mb-24"
    >
      <motion.p
        variants={{
        ...
        className="text text-7xl font-bold"
      >
        Get In Touch
      </motion.p>
